...
<template>
    <AuthenticatedLayout :user="user" :title="'Crear Usuarios'">
        <div class="row mb-3">
            ...
            <form class="px-3 py-1 row g-4" id="myForm" enctype="multipart/form-data" @submit.prevent="submit">
                ...
                <div class="col-lg-6 form-group">
                    <MaterialInput variant="static" type="number" name="cp" id="cp" label="Codigo Postal"
                        v-model="form.cp" :is-required="true" />
                </div>
                <hr>
                ...
                <div class="form-group col-lg-4 col-md-6">
                    <MaterialInput variant="static" :id="'password'" :label="'Contraseña'" :type="'password'"
                        v-model="form.password" :is-required="true" />
                </div>

                <div class="form-group col-lg-4 col-md-6">
                    <MaterialInput variant="static" :id="'password_confirm'" :label="'Confirmar Contraseña'"
                        :type="'password'" v-model="form.password_confirmation" :is-required="true" />
                </div>
