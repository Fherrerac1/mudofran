    <template>
        <BootstrapModal -modal-id="facturas-recurrentes-Modal" class="factura-recurrente-modal"
                                    ...
                                    <div class="card mt-3">
                                        <div class="card-header p-0 position-relative mx-3">
                                            <div class="style_color forms border-radius-lg p-3 ">
                                                <h5 class="font-weight-bold text-light mb-1">
                                                    Factura Recurrente: <small class="text-light">{{
                                                        factura.numFactura }}</small>
                                                </h5>
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" v-model="form.fechaInicio" id="fechaInicio"
                                                            class="form-control border px-3" :min="factura.fechaInicio"
                                                            required />
                                                    </div>
