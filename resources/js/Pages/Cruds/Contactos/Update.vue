...
export default {
    ...
    methods: {
        submit() {
            ...
            this.form.post(route('contactos.update', this.contacto.id), {
                onSuccess: () => {
                    Swal.fire({
                        icon: 'success',
                        title: 'Éxito',
...
<template>
    <AuthenticatedLayout :user="user" title="Editar Contacto">
        <div class="card mx-3 px-3" style="overflow-x: auto;">
            ...
            <form class="px-3 py-1 row g-4" @submit.prevent="submit" enctype="multipart/form-data">
                <h2 class="style_color text-center rounded">Editar Contacto</h2>
                <!-- Nombre -->
                ...
                <div class="col-md-6 form-group">
                    <MaterialInput variant="static" type="text" name="telefono_mobile" id="telefono_mobile"
                        ...
                        title="Introduce un número de 9 dígitos" maxlength="9" minlength="9" placeholder="123456789" />
                </div>
