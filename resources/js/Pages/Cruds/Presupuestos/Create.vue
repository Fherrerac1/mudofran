<template>
    <AuthenticatedLayout :user="user" :title="'Crear Presupuesto'">
                        ...
                        <div class="row col-lg-6">
                            ...
                            <div class="col-lg-6 form-group">
                                <MaterialInput type="date" name="fechaFin" id="fechaFin" label="Fecha de vencimiento"
                                    v-model="form.fechaFin" :is-read-only="true" variant="static" />
                            </div>
...
export default {
    ...
    methods: {
        ...
        submitForm() {
            const fotos = Array.from(this.$refs.documentInput.files);
            this.form.fotos = fotos;
            ...
            this.form.post(route('presupuestos.store'), {
                ...
                onError: () => {
                    if (this.form.errors) {
                        const errorMessages = Object.values(this.form.errors).flat().join('<br>');
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
                            html: errorMessages,
