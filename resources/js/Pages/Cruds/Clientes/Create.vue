    ...
    data() {
        return {
            ...
            form: useForm({
                ...
                apellido_1: '', // Optional field for the first last name
                apellido_2: '', // Optional field for the second last name
                email: this.contacto.email || '',
                contacto_id: this.contacto.id || '',
                telefono_mobile: this.contacto.telefono_mobile || '', // Mobile phone number
                telefono_fijo: '', // Optional field for a landline phone number
                dni: this.contacto.dni || '',
                direccion: '',
                localidad: '',
                provincia: '',
                pais: 'España', // Default country
                num_cuenta: '',
                descripcion: '',
                cp: '', // Postal code
                category: 'Personal', // Default category
                share_data: false,  // New field for switch
                api_key: '',        // New field for API Key
                dir3: '',        // New field for API Key
            }),
        };
    },
    props: {
