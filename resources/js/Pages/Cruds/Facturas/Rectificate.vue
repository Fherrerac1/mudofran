                ...
                <form @submit.prevent="submitForm">
                    ...
                    <div class="row">
                        ...
                        <div class="row col-lg-6">
                            ...
                            <!-- Issue Date -->
                            <div class="col-lg-6 form-group">
                                <MaterialInput type="date" name="fechaInicio" id="fechaInicio" :readonly="true"
                            ...
                            <div class="col-lg-6 form-group">
                                ...
                                <MaterialSelect disabled :is-required="true" id="metodo" v-model="form.serie"
                                    @update:model-value="handleSerieChange" :options="[
                                        { value: '1', text: 'serie 1 Factura normal' },
                                        { value: '2', text: 'serie 2 facturas rectificativas de las normales' },
                                        { value: '5', text: 'serie 5 autofacturación' },
                                    ]" />
                                <span>factura nativa : {{ factura.numFactura }}</span>
                            </div>
...
export default {
    ...
    mounted() {
        ...
        this.form.numFactura = this.numFactura
        this.form.fechaInicio = new Date().toISOString().slice(0, 10);
    },
};
</script>
