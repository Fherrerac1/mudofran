<template>
  ...
  <nav class="top-0 navbar navbar-expand-lg position-absolute z-index-3"
    ...
    <div class="container px-0">
      <router-link class="navbar-brand font-weight-bolder ms-lg-0 ms-3" to="/dashboard_admin" v-bind="$attrs"
      ...
      <div class="collapse navbar-collapse" id="navigation">
        ...
        <ul class="navbar-nav d-lg-block d-none">
          <li class="nav-item">
            <a href="https://www.creative-tim.com/product/vue-material-dashboard-laravel"
              class="btn btn-sm mb-0 me-1 bg-gradient-success" target="_blank">Free download</a>
          </li>
        </ul>
      </div>
    </div>
