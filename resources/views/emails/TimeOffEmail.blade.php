        ...
        <tr style="height: 76.46px;">
            <td style="padding: 50px 50px 20px 50px;">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        <a href="https://blackcat.es/" target="_blank"><img src="{{ asset('/images/App_Logo.png') }}"
        ...
        <tr style="height: 352px; font-size: 12px; font-weight: 400; line-height: 16px;">
            <td style="padding: 0px 50px;">
                ...
                @if ($timeOff->estado == 1)
                    ...
                    <p>
                        Te informamos que tu solicitud de permiso del
                        <strong>{{ \Carbon\Carbon::parse($timeOff->from)->format('d/m/Y') }}</strong> al
                        <strong>{{ \Carbon\Carbon::parse($timeOff->to)->format('d/m/Y') }}</strong> ha sido
                        <strong>APROBADA</strong>.
                    </p>
                    <p>
                        Agradecemos tu responsabilidad al gestionar tus tiempos de ausencia. Si tienes alguna pregunta o
                        necesitas realizar algún cambio, por favor comunícate con el área correspondiente.
                    </p>
                    <p>
                        Un cordial saludo,<br>
                        El equipo de {{ \App\Helpers\ConfigHelper::get('business_name') }}
                    </p>
                @elseif ($timeOff->estado == 2)
                    <p>
                        Estimado/a {{ $user->name }},
                    </p>
                    <p>
                    ...
                    <p>
                        Si deseas obtener más información sobre los motivos del rechazo o necesitas asistencia, no dudes
            ...
            <td style="padding: 20px;">
                <div style="color: #B0B0B0; font-weight: 600; font-size: 8px; line-height: 11px;">
                    <p style="font-size: 7px; text-align: justify">
                        ...
                        {{ \App\Helpers\ConfigHelper::get('province') }}, nuestra principal misión es preservar la
                        ética
