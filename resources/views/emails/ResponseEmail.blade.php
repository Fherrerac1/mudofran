        ...
        <tr style="height: 352px; font-size: 12px; font-weight: 400; line-height: 16px;">
            <td style="padding: 0px 50px;">
                <div>
                    ...
                    @if ($link)
                        <a href='{{ $link }}'
                            style='display: inline-block; padding: 10px 20px; font-size: 16px; color:
                 #fff; background-color: #007bff; text-decoration: none; border-radius: 5px;'
                            target='_blank'>Descargar Presupuesto</a>
                    @endif
